...
class ConverterToolsAPI(ApiCaller):
    ...
    def __init__(self, api_client):
        ...
        self.url = "https://online-multi-format-file-converter-tools-api.p.rapidapi.com/converters/html-to-pdf"

    def call_apis(self, method='GET', params=None, data=None, files=None):
        """
        ...
        """
        response = self.api_client.request(method, self.url, params=params, data=data, headers=self.headers, files=files)
